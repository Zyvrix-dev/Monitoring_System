      ...
      <div className="insights">
        <table className="insights-table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                {stats.netRxAvg?.avg !== null
                  ? formatThroughput(stats.netRxAvg.avg)
                  : "--"}
              </td>
              <td>
                {stats.netRxAvg?.peak !== null
                  ? formatThroughput(stats.netRxAvg.peak)
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.netTxAvg?.avg !== null
                  ? formatThroughput(stats.netTxAvg.avg)
                  : "--"}
              </td>
              <td>
                {stats.netTxAvg?.peak !== null
                  ? formatThroughput(stats.netTxAvg.peak)
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.swap?.avg !== null
                  ? formatPercentLabel(stats.swap.avg)
                  : "--"}
              </td>
              <td>
                {stats.swap?.peak !== null
                  ? formatPercentLabel(stats.swap.peak)
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.processes?.avg !== null
                  ? formatConnections(Math.round(stats.processes.avg))
                  : "--"}
              </td>
              <td>
                {stats.processes?.peak !== null
                  ? formatConnections(Math.round(stats.processes.peak))
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.threads?.avg !== null
                  ? formatConnections(Math.round(stats.threads.avg))
                  : "--"}
              </td>
              <td>
                {stats.threads?.peak !== null
                  ? formatConnections(Math.round(stats.threads.peak))
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.listeningTcp?.avg !== null
                  ? formatConnections(Math.round(stats.listeningTcp.avg))
                  : "--"}
              </td>
              <td>
                {stats.listeningTcp?.peak !== null
                  ? formatConnections(Math.round(stats.listeningTcp.peak))
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.listeningUdp?.avg !== null
                  ? formatConnections(Math.round(stats.listeningUdp.avg))
                  : "--"}
              </td>
              <td>
                {stats.listeningUdp?.peak !== null
                  ? formatConnections(Math.round(stats.listeningUdp.peak))
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.openFds?.avg !== null
                  ? formatConnections(Math.round(stats.openFds.avg))
                  : "--"}
              </td>
              <td>
                {stats.openFds?.peak !== null
                  ? formatConnections(Math.round(stats.openFds.peak))
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.uniqueDomains?.avg !== null
                  ? formatConnections(Math.round(stats.uniqueDomains.avg))
                  : "--"}
              </td>
              <td>
                {stats.uniqueDomains?.peak !== null
                  ? formatConnections(Math.round(stats.uniqueDomains.peak))
                  : "--"}
              </td>
            </tr>
            <tr>
              ...
              <td>
                {stats.load1?.avg !== null ? formatLoad(stats.load1.avg) : "--"}
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                {stats.load5?.avg !== null ? formatLoad(stats.load5.avg) : "--"}
              </td>
              <td>
        ...
        <div className="insights-meta" role="list">
          ...
          <div className="insights-meta__item" role="listitem">
            ...
            <p className="insights-meta__value">
              {latestMetric?.dockerAvailable
                ? `${formatConnections(
                    latestMetric?.dockerContainers?.length ?? 0
                  )} running`
                : "Unavailable"}
            </p>
          </div>
          <div className="insights-meta__item" role="listitem">
            ...
            <p className="insights-meta__value">
              {formatPercent(latestMetric?.cpuAvg)}%
            </p>
          </div>
        </div>
      </div>
